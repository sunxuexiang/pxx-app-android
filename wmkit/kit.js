...
export const logout = () => {
  ...
  AsyncStorage.removeItem(cache.MATCHING_WAREHOUSE_FLAG);
  // AsyncStorage.removeItem(cache.MATCH_WARE_STORE);
  AsyncStorage.removeItem(cache.CHOOSE_POSITION_CITY_CODE);
  AsyncStorage.removeItem(cache.GOODS_DETAIL);
 ...
 * @param {*} goodsInfo 
 */
export const isInvalid = (goodsInfo) => {
