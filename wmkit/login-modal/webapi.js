 ...
 * @param password
 */
export const registerModal = (account, password,telCode, inviteCode,customerRegisterType,enterpriseName,socialCreditCode,businessLicenseUrl,customerTag,enterpriseStatusXyy,employeeCode) => {
  return Fetch('/register/modal', {
    ...
    body: JSON.stringify({
      ...
      customerRegisterType: customerRegisterType,
      enterpriseName:enterpriseName,
      socialCreditCode:socialCreditCode,
      businessLicenseUrl:businessLicenseUrl,
      customerTag:customerTag,
      enterpriseStatusXyy:enterpriseStatusXyy,
