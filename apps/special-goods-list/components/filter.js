...
import { Image, ScrollView, StyleSheet, Text, TouchableOpacity, TouchableWithoutFeedback, View,PixelRatio } from 'react-native';
...
export default class Cate extends React.Component {
  ...
  render() {
    ...
    let { closeShade, brandList, isDistributor, iepInfo } = this.props.relaxProps;
          ...
          <ScrollView style={{ flex: 1 }}>
            {/* <View style={styles.filterItem}>
              ...
              <View style={styles.sortCon}>
                ...
                {isDistributor && <TouchableOpacity
                  style={[
                    styles.sortItem,
                    this.state.selectShareProfits && { borderColor: mainColor }
                  ]}
                  activeOpacity={0.8}
