...
@Relax
export default class GoodsAppointmentRule extends Component {
  static relaxProps = {
  ...
  render() {
    let { ruleContent, changeAppointmentRuleVisible } = this.props.relaxProps;
    ...
    return (
      <View style={styles.mask}>
        ...
        <TouchableOpacity
          style={styles.close}
          activeOpacity={0.8}
          onPress={() => changeAppointmentRuleVisible()}
        >
          <Image
