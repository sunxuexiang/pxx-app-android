...
export default class GoodsTabActor extends Actor {
  ...
  @Action('change:CateId')
  isCateId(state, CateId) {
  ...
  initBrand(state, filters) {
    return state.set('brandList', filters);
  }

  @Action('goods-list:selectedBrandIds')
  selectedBrandIds(state, selectedBrandIds) {
    return state.set('selectedBrandIds', fromJS(selectedBrandIds));
  }
  ...
  filterChange(
    ...
    return state.withMutations((state) => {
      state
        ...
        .set('isIep', isIep)
        .set('pointsUsageFlag',pointsUsageFlag)
    });
  }
